...
public class ArmNew extends Encoder {
    ...
    public DcMotor horizontal = null; // horizontal linear lift
    ...
    public ArmNew(HardwareMap hwMap, Telemetry telemetry) {
    ...
    private void init_horizontal() {
        ...
        //horizontal.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER); //this behave not as expected
        horizontal.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        horizontal.setPower(0.0);
        h_position = horizontal.getCurrentPosition();
    }
    ...
    public ArmNew(Telemetry telemetry, HardwareMap hwMap) { // }, liftType type) {
        /* Initialize standard Hardware interfaces */
        this.hwMap = hwMap;
        this.telemetry = telemetry;
        //init_v_pivot();
...
/*
    ...
    //expand the horizontal slider
    public void horizontalExpand() {
        h_position = horizontal.getCurrentPosition();
        h_target = h_position + 80;
        runToPosition(horizontal, 0.3, h_target);
        //runToDistance(v_pivot, 0.3, v_target, telemetry)
       // vmove(80, 0.3, 60);

    }
    //shrink the horizontal slider
    public void horizontalShrink() {
        h_position = horizontal.getCurrentPosition();
        h_target = h_position - 80;
        runToPosition(horizontal, 0.1, h_target);
    }

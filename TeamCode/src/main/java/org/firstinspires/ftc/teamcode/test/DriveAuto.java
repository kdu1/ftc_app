...
@Autonomous(name="Drive Auto", group="test")
@Disabled
public class DriveAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException { //need throw for landing() method
        ...
        while (opModeIsActive() && (runtime.seconds() < 8.0)) {
            ...
            String location = gold.getPosition();
            telemetry.addData("Sampleing Gold: ", location);
            telemetry.update();
            // step 2: get rid of the gold
            arm.gold(location, 8.0);
        }
        ...
        while (opModeIsActive() && (runtime.seconds() < 10.0)) {
            ...
            lift.landing(10.0); //lift goes up
        }
        lift.stop();
        sleep(100);

        lift.landing(0.3); //slower down a little
        runtime.reset();
